...
(setq sql-postgres-options '("exec" "-ti" "practical_shockley" "psql" "-U" "postgres"))
...
#+begin_src emacs-lisp
(set-fontset-font nil 'symbol (font-spec :family "Apple Color Emoji" :size 15))
(set-fontset-font nil 'ascii (font-spec :family "FreeMono" :size 16))
(set-fontset-font nil 'japanese-jisx0208 (font-spec :family "しっぽり明朝" :size 20))
(set-fontset-font nil 'japanese-jisx0208-1978 (font-spec :family "しっぽり明朝" :size 20))
(set-fontset-font nil 'japanese-jisx0212 (font-spec :family "しっぽり明朝" :size 20))
(set-fontset-font nil 'japanese-jisx0213.2004-1 (font-spec :family "しっぽり明朝" :size 20))
(set-fontset-font nil 'jisx0201 (font-spec :family "IPA明朝" :size 20))
#+end_src
