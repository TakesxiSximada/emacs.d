...
#+begin_src emacs-lisp
(set-fontset-font nil 'unicode (font-spec :family "Menlo" :size 12))
(set-fontset-font nil 'katakana-jisx0201 (font-spec :family "游明朝体+36ポかな" :size 14))
(set-fontset-font nil 'japanese-jisx0208 (font-spec :family "游明朝体+36ポかな" :size 14))
(set-fontset-font nil '(#x1F004 . #x1FFFD) (font-spec :family "Symbola" :size 14))
#+end_src
