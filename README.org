...
#+begin_src emacs-lisp
(progn
  (set-fontset-font nil 'symbol (font-spec :family "Apple Color Emoji" :size 13))
  (set-fontset-font nil 'ascii (font-spec :family "FreeMono" :size 15))
  (set-fontset-font nil 'japanese-jisx0208 (font-spec :family "しっぽり明朝" :size 18))
  (set-fontset-font nil 'japanese-jisx0208-1978 (font-spec :family "しっぽり明朝" :size 18))
  (set-fontset-font nil 'japanese-jisx0212 (font-spec :family "しっぽり明朝" :size 18))
  (set-fontset-font nil 'japanese-jisx0213.2004-1 (font-spec :family "しっぽり明朝" :size 18))
  (set-fontset-font nil 'jisx0201 (font-spec :family "IPA明朝" :size 18))
  )
#+end_src
