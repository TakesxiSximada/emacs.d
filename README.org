...
(setq org-agenda-prefix-format
      '((agenda . "%4(org-clock-sum-current-item-custom) %4e %t %.8s %-4.4c %-25.50b ")
        (todo . " %i %-12:c %-6e")
        (tags . " %i %-12:c")
        (search . " %i %-12:c")))
#+end_src
...
(setq org-agenda-sorting-strategy
    '((agenda habit-down time-up category-keep effort-up priority-down)
...
;;   (set-fontset-font nil 'ascii (font-spec :family "FreeMono" :size 13))
;;   (set-fontset-font nil 'japanese-jisx0208 (font-spec :family "しっぽり明朝" :size 16))
;;   (set-fontset-font nil 'japanese-jisx0208-1978 (font-spec :family "しっぽり明朝" :size 16))
;;   (set-fontset-font nil 'japanese-jisx0212 (font-spec :family "しっぽり明朝" :size 16))
;;   (set-fontset-font nil 'japanese-jisx0213.2004-1 (font-spec :family "しっぽり明朝" :size 16))
;;   (set-fontset-font nil 'jisx0201 (font-spec :family "IPA明朝" :size 16))
;;   )
#+end_src
